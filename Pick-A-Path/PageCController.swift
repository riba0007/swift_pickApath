...
class PageCController: UIViewController {
    //Outlets
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        //get next controller
        let destinationController = segue.destination as? PageDController
    ...
    @IBAction func pageButtonA(_ sender: Any) {
        performSegue(withIdentifier: "showPageD" , sender: "buttonA")
    }
    @IBAction func pageButtonB(_ sender: Any) {
        performSegue(withIdentifier: "showPageD" , sender: "buttonB")
    }
